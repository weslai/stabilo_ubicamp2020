...
import warnings
warnings.filterwarnings("ignore")  # Suppress warning on RNN dropout
...
class Cnn_LstmNet(nn.Module):
    def __init__(self, inplanes, outplanes, num_classes=52):
        ...
        self.rnn = nn.LSTM(input_size= 4 * outplanes, hidden_size= 8 * outplanes, num_layers= 1, dropout=0.2,
